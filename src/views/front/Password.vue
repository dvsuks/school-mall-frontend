        ...
        <div class="card" style="width:40%">
            ...
            <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px"
                ...
                <el-form-item prop="password" label="密码">
                    <el-input v-model="data.user.password" placeholder="请输入密码  " autocomplate="off"
                        show-password></el-input>
                </el-form-item>
                <el-form-item prop="newpassword" label="新密码">
                    <el-input v-model="data.user.newpassword" placeholder="请输入新密码  " autocomplate="off"
                        show-password></el-input>
                </el-form-item>
                <el-form-item prop="confirmpassword" label="确认新密码">
                    <el-input v-model="data.user.confirmpassword" placeholder="请输入确认密码  " autocomplate="off"
                        show-password></el-input>
