  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table  tooltip-effect="dark myEff":data="data.tableData" stripe>
       ...
       <el-table-column prop="saleCount" label="销售量"></el-table-column>
    ...
    <el-dialog title="商品信息" width="30%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="80px" :rules="data.rules"style="padding-right: 30px">
      ...
      <el-form-item prop="categoryId" label="分类">
        ...
        <el-form-item prop="views" label="浏览量">
            <el-input v-model="data.form.views" placeholder="请输入浏览量"></el-input>
        </el-form-item>
        <el-form-item prop="saleCount" label="销量">
            <el-input v-model="data.form.saleCount" placeholder="请输入销量"></el-input>
        </el-form-item>
    ...
    <el-dialog title="商品详情" v-model="data.viewVisible" width="50%":close-on-click-modal="false" destroy-on-close>
      ...
      <template #footer>
      <span class="dialog-footer">
        <el-button type="primary" @click="data.viewVisible = false">关 闭</el-button>
      </span>
      </template>
      </el-dialog>
  </div>
...
const load = () => {
  request.get('/goods/selectPage', {
    ...
    data.tableData.forEach(v=>{
      v.recommendActive=v.recommed==='是'
    })
  })
}
...
// 新增
const handleAdd = () => {
  data.form = {status:'上架',price:0,recommed:'否'}
